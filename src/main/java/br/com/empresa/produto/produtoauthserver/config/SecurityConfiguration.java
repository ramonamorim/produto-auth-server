...
import br.com.empresa.produto.produtoauthserver.security.jsonwebtoken.CustomAuthenticationConverter;
import br.com.empresa.produto.produtoauthserver.security.jsonwebtoken.CustomPasswordEncoder;
import br.com.empresa.produto.produtoauthserver.security.jsonwebtoken.CustomReactiveAuthenticationManager;
import br.com.empresa.produto.produtoauthserver.security.jsonwebtoken.JwtAuthenticationEntryPoint;
import br.com.empresa.produto.produtoauthserver.service.CustomReactiveUserDetailsService;
	...
	private AuthenticationWebFilter apiAuthenticationWebFilter() {
		try {
			...
			throw new BeanInitializationException(
					"Could not initialize AuthenticationWebFilter apiAuthenticationWebFilter.", e);
		}
	}
